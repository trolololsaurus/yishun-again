...
export default function TimelinePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 w-full flex-1 flex flex-col">
      <h1 className="font-display text-amber mb-4" style={{ fontSize: '32px' }}>HISTORY</h1>
