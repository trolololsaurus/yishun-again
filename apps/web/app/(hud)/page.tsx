...
export default async function FeedPage() {
  ...
  const { data: feedRows } = await supabase
    .from('incidents')
    .select('id,slug,title,summary,classification,custom_label,severity,corroboration_count,published_at,incident_date,area_name,is_milestone,milestone_type,milestone_value,is_developing,update_count,first_reported_at,source_urls,source_timeline,latest_source_role,pixel_art_url')
