  ...
  return (
    <article className="bg-surface border border-border rounded opacity-90">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
        <span className="px-2 py-0.5 bg-text-secondary text-bg font-bold uppercase text-xs">
          AUTO-CONCLUDED
        </span>
        <span className="text-text-secondary text-sm">Lifecycle</span>
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-t border-border">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            disabled={loading}
            className="px-4 py-2 bg-text-secondary text-bg text-sm font-bold hover:opacity-90 transition-opacity disabled:opacity-50"
          >
